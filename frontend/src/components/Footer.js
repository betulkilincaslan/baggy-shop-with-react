...
const Footer = () => {
  return (
    <footer className="py-16 xl:px-20 lg:px-12 sm:px-6 px-4 bg-gray-200">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-10 container mx-auto max-w-7xl">
        <div className="flex flex-col items-center md:items-start flex-shrink-0">
          <div className="font-semibold text-xl text-gray-800">Baggy Shop</div>
          <p className="text-sm leading-none text-gray-800 mt-4">
            Copyright © 2021 Baggy Shop
          </p>
          <p className="text-sm leading-none text-gray-800 mt-4">
            All rights reserved
          </p>
          <div className="flex items-center gap-x-4 mt-8 md:mt-10">
            ...
            <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
              <i className="bx bxl-pinterest-alt text-white"></i>
            </div>
            <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
        ...
        <div className="flex flex-col items-center md:items-start gap-6">
          <h2 className="text-base font-semibold leading-4 text-gray-800 uppercase">
            How can we help?
          </h2>
        ...
        <div className="mt-10 lg:block hidden">
          ...
          <div className="cursor-pointer flex items-center justify-between border border-gray-400 mt-4">
            <input
              type="text"
      ...
      <div className="mt-12 lg:hidden">
        ...
        <div className="flex items-center justify-between border border-gray-400 mt-4">
          <input
            type="text"
